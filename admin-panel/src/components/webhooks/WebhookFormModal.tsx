              ...
              {editingEndpoint ? (
                <div className="flex relative">
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-gf-border-medium bg-gf-deep text-gf-muted font-mono text-sm pr-20"
                  />
                  <div className="absolute right-2 top-1/2 -translate-y-1/2 flex space-x-1">
                    <button
                      type="button"
                      onClick={() => setShowSecret(!showSecret)}
                      className="p-1.5 text-gf-muted hover:text-gf-heading hover:bg-gf-raised"
                ...
                <div className="w-full px-3 py-2 border-2 border-gf-border-medium bg-gf-deep text-gf-muted italic text-sm">
