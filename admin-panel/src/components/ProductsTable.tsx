                      ...
                      <div className="flex items-center max-w-[300px]">
                        ...
                        <div className="ml-3 min-w-0 flex-1 overflow-hidden">
                          <div className="flex items-center gap-1">
                            ...
                            {product.is_featured && (
                              <span className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 flex-shrink-0">
                                ⭐
                              </span>
                            )}
                          </div>
