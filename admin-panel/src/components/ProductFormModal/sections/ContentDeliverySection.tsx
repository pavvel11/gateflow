      ...
      <div className="space-y-4">
        ...
        {formData.content_delivery_type === 'content' && (
          <div>
            ...
            {hasVideoEmbeds && (
              <div className="mb-3 p-3 bg-sf-accent-soft border border-sf-accent/20">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h4 className="text-sm font-medium text-sf-accent">{t('supportedVideoPlatforms')}</h4>
                    <p className="text-xs text-sf-accent mt-1">
                      {t('supportedVideoPlatformsDesc')}
                    </p>
                    <div className="mt-2 text-xs text-sf-accent">
            ...
            {hasDownloadLinks && (
              <div className="mb-3 p-3 bg-sf-success-soft border border-sf-success/20">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <svg className="h-5 w-5 text-sf-success" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <div className="ml-3">
                    <h4 className="text-sm font-medium text-sf-success">{t('trustedStorageProviders')}</h4>
                    <p className="text-xs text-sf-success mt-1">
                      {t('trustedStorageProvidersDesc')}
                    </p>
                    <div className="mt-2 text-xs text-sf-success leading-relaxed">
                ...
                <div key={index} className="p-3 bg-sf-raised border-2 border-sf-border-medium">
                  ...
                  {urlValidation[index] && (
                    <div className={`mt-2 text-xs flex items-start space-x-1 ${
                      urlValidation[index].isValid ? 'text-sf-success' : 'text-sf-danger'
                    }`}>
                      {urlValidation[index].isValid ? (
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                        ...
                        <label className="flex items-center space-x-1 text-xs cursor-pointer">
                          <input
                            ...
                            className="h-3 w-3 text-sf-accent focus:ring-sf-accent border-sf-border rounded"
                          />
                          <span className="text-sf-body">{t('controls')}</span>
                        </label>
                      </div>
