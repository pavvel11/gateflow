  ...
  if (loadingTimedOut || accessError) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gf-deep">
        ...
        <div className="max-w-md mx-auto p-8 bg-gf-raised/80 border border-gf-border rounded-xl shadow-2xl text-center">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 bg-gf-accent hover:bg-gf-accent/80 text-white font-medium rounded-lg transition-colors"
          >
            {t('tryAgain')}
          </button>
        </div>
  ...
  if (redirecting || (accessData?.hasAccess && product.content_delivery_type === 'redirect')) {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gf-deep overflow-hidden relative font-sans">
        <FloatingToolbar position="top-right" />
        <div className="max-w-md mx-auto p-8 bg-gf-raised/80 border border-gf-border rounded-xl shadow-2xl z-10 text-center">
