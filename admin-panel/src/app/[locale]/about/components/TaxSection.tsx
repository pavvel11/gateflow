  ...
  return (
    <section className="py-24 md:py-32 bg-gf-deep">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Comparison cards */}
        <StaggerReveal className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {/* MoR card */}
          <div className="p-8 rounded-2xl border-2 border-gf-danger/30 bg-gf-danger-soft">
          ...
          {/* Own Stripe card */}
          <div className="p-8 rounded-2xl border-2 border-gf-success/40 bg-gf-success-soft ring-2 ring-gf-success/20 relative">
        ...
        <ScrollReveal className="mb-8">
          ...
          <StaggerReveal className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-gf-raised/60 backdrop-blur-sm border border-gf-border">
