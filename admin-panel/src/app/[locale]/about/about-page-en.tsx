          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 lg:row-span-2 group relative p-8 rounded-3xl bg-gradient-to-br from-purple-500 to-pink-500 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">Stripe Payments</h3>
                <p className="text-lg text-purple-100 mb-6">
                  Complete checkout flow with embedded Stripe, multi-currency support (20+ currencies),
                  guest checkout, and encrypted key storage. Accept payments in minutes.
                </p>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-center">
                    ...
                    Bank-level encryption for payment keys
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-blue-500 to-cyan-500 hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-blue-100">
                Live revenue dashboard with multi-currency conversion, goals tracking, and instant notifications
              </p>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-green-500 to-emerald-500 hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Order Bumps & Upsells</h3>
              <p className="text-green-100">
                One-click upsells at checkout. Increase AOV by 30-50% with smart product bundling
              </p>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-orange-500 to-red-500 hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Smart Coupons</h3>
              <p className="text-orange-100">
                Auto-apply codes, email targeting, product restrictions, and usage limits
              </p>
            </div>
            ...
            <div className="lg:col-span-2 group p-8 rounded-3xl bg-gradient-to-br from-indigo-500 to-purple-500 hover:scale-105 transition-transform duration-300">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3">Webhooks & Automation</h3>
                  <p className="text-indigo-100 mb-4">
                    Connect to Zapier, Make, or custom endpoints. HMAC-secured delivery with logs and retries
                  </p>
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 rounded-full bg-white/20 text-white text-sm font-medium">Custom</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-gradient-to-br from-pink-500 to-rose-500 hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Zero-Friction Lead Collection</h3>
              <p className="text-pink-100">
                Free products with magic links. Collect emails without forms. Build your list, then sell premium.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
            Stop paying SaaS fees.
            <br />
            Start today. For free.
          </h2>
          <p className="text-xl md:text-2xl text-purple-100 mb-12 max-w-3xl mx-auto">
            Join creators who keep 100% of their revenue. Deploy GateFlow in minutes and own your business forever.
          </p>
