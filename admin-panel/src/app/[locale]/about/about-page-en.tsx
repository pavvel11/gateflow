          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="https://github.com/jurczykpawel/gateflow" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Documentation</a></li>
                <li><Link href="/store" className="hover:text-white transition-colors">Products</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="https://github.com/jurczykpawel/gateflow/blob/main/docs/DEPLOYMENT-MIKRUS.md" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Deploy Guide</a></li>
                <li><a href="https://github.com/jurczykpawel/gateflow/issues" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Support</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="https://github.com/jurczykpawel/gateflow/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">License (MIT)</a></li>
